...
const FAQS = [
  ...
  { q:"Why do you need to know which Guangna sets I own?", a:"This lets us match every palette directly to the brush markers you have. You'll get combinations you can actually use right away, no guesswork, no missing colors." },
  { q:"Does Guangna by Number work with all Guangna markers?", a:"It works with any of the sets listed right on our creation page! If you don't see your specific markers there, just drop us an email—we would be happy to add them for you." },
