...
export const GN_COLORS: Record<string,[number,number,number,string]> = {
    ...
    "GN-873":[237,206,223,"Ballet pink"],"GN-874":[232,218,179,"Light sand yellow"],"GN-875":[156,82,50,"Honey brown"],
    ...
    "GN-915":[223,172,145,"Dark skin brown"],"GN-916":[220,163,122,"Crab shell red"],"GN-917":[240,214,218,"Light coral"],
